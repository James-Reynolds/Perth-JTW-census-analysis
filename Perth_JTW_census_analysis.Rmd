...
## 4.1 Changes in mode share 


The following summarises the mode/activity share and number of people using each mode/working from home for the 2016 and 2021 censuses. 

```{r summary_table, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}

#build summary table with transit modes aggregated
transit_aggregate_summary_table <- tibble(summary_table[,"Year"], summary_table[,"usual_residence"], summary_table[,"place_of_work"], dplyr::mutate(summary_table, "transit" = rowSums((summary_table[,4:7]), na.rm = TRUE))[,"transit"], summary_table[,"private_vehicle_drive"], summary_table[,"private_vehicle_passenger"], summary_table[,"non_motorised"], summary_table[,"other_mode"], summary_table[,"worked_at_home"])

transit_aggregate_summary_table_split <- split(transit_aggregate_summary_table, transit_aggregate_summary_table$Year)

kable(transit_aggregate_summary_table_split %>% adorn_totals(where = "col") %>% adorn_percentages(denominator = "row") %>% adorn_pct_formatting() %>% adorn_ns(), col.names = c("Year", "UR", "POW", "Transit","Drive", "Passenger", "Walk/Bike", "Other", "WFH", "Total"))
...
```{r summary_table_differences, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}

transit_aggregate_summary_table_wider <- pivot_wider(transit_aggregate_summary_table, names_from = Year, values_from = c(transit, private_vehicle_drive, private_vehicle_passenger, non_motorised, other_mode, worked_at_home))

change_transit_aggregate_summary_table <- tibble(
  usual_residence = transit_aggregate_summary_table_wider$usual_residence, 
  place_of_work = transit_aggregate_summary_table_wider$place_of_work, 
  transit = transit_aggregate_summary_table_wider$transit_2021 - transit_aggregate_summary_table_wider$transit_2016, 
  private_vehicle_drive = transit_aggregate_summary_table_wider$private_vehicle_drive_2021 - transit_aggregate_summary_table_wider$private_vehicle_drive_2016, 
  private_vehicle_passenger = transit_aggregate_summary_table_wider$private_vehicle_passenger_2021 - transit_aggregate_summary_table_wider$private_vehicle_passenger_2016, 
  non_motorised = transit_aggregate_summary_table_wider$non_motorised_2021 - transit_aggregate_summary_table_wider$non_motorised_2016, 
  other_mode = transit_aggregate_summary_table_wider$other_mode_2021 - transit_aggregate_summary_table_wider$other_mode_2016,
  worked_at_home = transit_aggregate_summary_table_wider$worked_at_home_2021 - transit_aggregate_summary_table_wider$worked_at_home_2016
  )

#mode share changes
kable(change_transit_aggregate_summary_table %>% adorn_totals(where = "col") %>% adorn_percentages(denominator = "row") %>% adorn_pct_formatting(), col.names = c("UR", "POW", "Transit","Drive", "Passenger", "Walk/Bike", "Other", "WFH", "Total"), caption = "Change in mode share by place of usual residence and place of work") %>%
  column_spec(3, color = "white",
              background = spec_color(change_transit_aggregate_summary_table$transit[1:13]/rowSums(change_transit_aggregate_summary_table[,3:8]), end = 0.7))  %>%
  column_spec(4, color = "white",
              background = spec_color(change_transit_aggregate_summary_table$private_vehicle_drive[1:13]/rowSums(change_transit_aggregate_summary_table[,3:8]), end = 0.7)) %>%
  column_spec(5, color = "white",
              background = spec_color(change_transit_aggregate_summary_table$private_vehicle_passenger[1:13]/rowSums(change_transit_aggregate_summary_table[,3:8]), end = 0.7)) %>%
  column_spec(6, color = "white",
              background = spec_color(change_transit_aggregate_summary_table$non_motorised[1:13]/rowSums(change_transit_aggregate_summary_table[,3:8]), end = 0.7)) %>%
  column_spec(7, color = "white",
              background = spec_color(change_transit_aggregate_summary_table$other_mode[1:13]/rowSums(change_transit_aggregate_summary_table[,3:8]), end = 0.7)) %>%
  column_spec(8, color = "white",
              background = spec_color(change_transit_aggregate_summary_table$worked_at_home[1:13]/rowSums(change_transit_aggregate_summary_table[,3:8]), end = 0.7)) 

```


The change in mode share table immediately above indicates that:
____TO DO_____
WRITE TEXT 
...
The next tables show the changes in the people/drivers/passengers using each mode or working from home, for each place of usual residence and place of work. 

```{r summary_table_differences_percentage, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}


percent_change_transit_aggregate_summary_table <- tibble(
  usual_residence = transit_aggregate_summary_table_wider$usual_residence, 
  place_of_work = transit_aggregate_summary_table_wider$place_of_work, 
  transit = transit_aggregate_summary_table_wider$transit_2021 / transit_aggregate_summary_table_wider$transit_2016 - 1, 
  private_vehicle_drive = transit_aggregate_summary_table_wider$private_vehicle_drive_2021 / transit_aggregate_summary_table_wider$private_vehicle_drive_2016 -1, 
  private_vehicle_passenger = transit_aggregate_summary_table_wider$private_vehicle_passenger_2021 / transit_aggregate_summary_table_wider$private_vehicle_passenger_2016 -1, 
  non_motorised = transit_aggregate_summary_table_wider$non_motorised_2021 / transit_aggregate_summary_table_wider$non_motorised_2016 -1 , 
  other_mode = transit_aggregate_summary_table_wider$other_mode_2021 / transit_aggregate_summary_table_wider$other_mode_2016 -1,
  worked_at_home = transit_aggregate_summary_table_wider$worked_at_home_2021 / transit_aggregate_summary_table_wider$worked_at_home_2016 -1
  )


#Volume changes
kable(change_transit_aggregate_summary_table %>% adorn_totals(where = "col") %>% adorn_ns(), col.names = c("UR", "POW", "Transit","Drive", "Passenger", "Walk/Bike", "Other", "WFH", "Total"), caption = "Change in number of people using each mode / working from home, by place of usual residence and place of work")



kable(percent_change_transit_aggregate_summary_table %>% adorn_pct_formatting(), col.names = c("UR", "POW", "Transit","Drive", "Passenger", "Walk/Bike", "Other", "WFH"), caption = "Percentage change in number of people using each mode / working from home, by place of usual residence and place of work" )  %>%
  column_spec(3, color = "white",
              background = spec_color(percent_change_transit_aggregate_summary_table$transit[1:13], end = 0.7))  %>%
  column_spec(4, color = "white",
              background = spec_color(percent_change_transit_aggregate_summary_table$private_vehicle_drive[1:13], end = 0.7)) %>%
  column_spec(5, color = "white",
              background = spec_color(percent_change_transit_aggregate_summary_table$private_vehicle_passenger[1:13], end = 0.7)) %>%
  column_spec(6, color = "white",
              background = spec_color(percent_change_transit_aggregate_summary_table$non_motorised[1:13], end = 0.7)) %>%
  column_spec(7, color = "white",
              background = spec_color(percent_change_transit_aggregate_summary_table$other_mode[1:13], end = 0.7)) %>%
  column_spec(8, color = "white",
              background = spec_color(percent_change_transit_aggregate_summary_table$worked_at_home[1:13], end = 0.7)) 
...
## 4.2 Changes in transit mode share 

___TO DO____
update this section to match above


```{r summary_table_transit_breakdown, include=TRUE}
...
The next table shows the changes in the number of people for each place of usual residence and place of work. 

```{r summary_table_differences_transit_breakdown, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}

transit_breakdown_summary_table_wider <- pivot_wider(transit_breakdown_summary_table, names_from = Year, values_from = c(train, bus, ferry, tram, non_transit, worked_at_home))

change_transit_breakdown_summary_table <- tibble(
  usual_residence = transit_breakdown_summary_table_wider$usual_residence, 
  place_of_work = transit_breakdown_summary_table_wider$place_of_work, 
  train = transit_breakdown_summary_table_wider$train_2021 - transit_breakdown_summary_table_wider$train_2016, 
  bus = transit_breakdown_summary_table_wider$bus_2021 - transit_breakdown_summary_table_wider$bus_2016, 
  ferry = transit_breakdown_summary_table_wider$ferry_2021 - transit_breakdown_summary_table_wider$ferry_2016, 
  tram = transit_breakdown_summary_table_wider$tram_2021 - transit_breakdown_summary_table_wider$tram_2016, 
  non_transit = transit_breakdown_summary_table_wider$non_transit_2021 - transit_breakdown_summary_table_wider$non_transit_2016,
  worked_at_home = transit_breakdown_summary_table_wider$worked_at_home_2021 - transit_breakdown_summary_table_wider$worked_at_home_2016
  )

kable(change_transit_aggregate_summary_table %>% adorn_totals(where = "col") %>% adorn_percentages(denominator = "row") %>% adorn_pct_formatting() %>% adorn_ns(), col.names = c("UR", "POW", "Train","Bus", "Ferry", "Tram", "Non-transit", "WFH", "Total"))


```

The next table shows the changes in the percentage of people for each place of usual residence and place of work. 

```{r transit_breakdown_summary_table_percent_differences, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}


percent_change_transit_breakdown_summary_table <- tibble(
  usual_residence = transit_breakdown_summary_table_wider$usual_residence, 
  place_of_work = transit_breakdown_summary_table_wider$place_of_work, 
  train = transit_breakdown_summary_table_wider$train_2021 / transit_breakdown_summary_table_wider$train_2016 - 1, 
  bus = transit_breakdown_summary_table_wider$bus_2021 / transit_breakdown_summary_table_wider$bus_2016 -1, 
  ferry = transit_breakdown_summary_table_wider$ferry_2021 / transit_breakdown_summary_table_wider$ferry_2016 -1, 
  tram = transit_breakdown_summary_table_wider$tram_2021 / transit_breakdown_summary_table_wider$tram_2016 -1 , 
  non_transit = transit_breakdown_summary_table_wider$non_transit_2021 / transit_breakdown_summary_table_wider$non_transit_2016 -1,
  worked_at_home = transit_breakdown_summary_table_wider$worked_at_home_2021 / transit_breakdown_summary_table_wider$worked_at_home_2016 -1
  )

kable(percent_change_transit_breakdown_summary_table %>% adorn_pct_formatting(), col.names = c("UR", "POW", "Train","Bus", "Ferry", "Tram", "Non-transit", "WFH"))  %>%
  column_spec(3, color = "white",
              background = spec_color(percent_change_transit_breakdown_summary_table$train[1:13], end = 0.7))  %>%
  column_spec(4, color = "white",
              background = spec_color(percent_change_transit_breakdown_summary_table$bus[1:13], end = 0.7)) %>%
  column_spec(5, color = "white",
              background = spec_color(percent_change_transit_breakdown_summary_table$ferry[1:13], end = 0.7)) %>%
  column_spec(6, color = "white",
              background = spec_color(percent_change_transit_breakdown_summary_table$tram[1:13], end = 0.7)) %>%
  column_spec(7, color = "white",
              background = spec_color(percent_change_transit_breakdown_summary_table$non_transit[1:13], end = 0.7)) %>%
  column_spec(8, color = "white",
              background = spec_color(percent_change_transit_breakdown_summary_table$worked_at_home[1:13], end = 0.7)) 
