...
Greater_Perth_JTW_by_DZ_and_LGA_2016 <- tibble(
  ...
  dz_code_2016 = Greater_Perth_JTW_by_DZ_and_LGA_2016$`DZN (POW)`,
...
Greater_Perth_JTW_by_DZ_and_LGA_2016 <- tibble(lga_name_2021 = Greater_Perth_JTW_by_DZ_and_LGA_2016$lga_name_2021, dz_code_2021 = Greater_Perth_JTW_by_DZ_and_LGA_2016$DZN_CODE_2021, Greater_Perth_JTW_by_DZ_and_LGA_2016[,24:39])
...
library(readr)
X2016_WA_age_by_LGA <- read_csv("~/0001 projects/Perth-JTW-census-analysis/01 data/2016_WA_Age_by_LGA.csv", skip = 8)
X2016_WA_employment_by_LGA <- read_csv("~/0001 projects/Perth-JTW-census-analysis/01 data/2016_WA_employment_by_LGA.csv", skip=8)
X2021_WA_age_by_LGA <- read_csv("~/0001 projects/Perth-JTW-census-analysis/01 data/2021_WA_Age_by_LGA.csv", skip=8)
X2021_WA_employment_by_LGA <- read_csv("~/0001 projects/Perth-JTW-census-analysis/01 data/2021_WA_Employment_by_LGA.csv", skip=8)
...
```{r Greater_Perth_JTW_aggregate_CBD_vs_non_CBD, echo=FALSE, message=FALSE, warning=FALSE, fig.margin=FALSE, fig.fullwidth=FALSE, fig.cap="Perth CBD vs rest of Greater Perth, 2021 destination zones"}
...
Greater_Perth_JTW_by_destination_2021 <- left_join(DZ2021_map_data %>%
  filter(gcc_name_2021 == "Greater Perth"), CBD_dz_codes)

#Change NA to non-CBD for all other DZ in Greater Perth
Greater_Perth_JTW_by_destination_2021$Location <- replace_na(Greater_Perth_JTW_by_destination_2021$Location, "non-CBD")



#Map destination zones
map <- Greater_Perth_JTW_by_destination_2021 %>%
   ggplot() +
  geom_sf(aes(geometry = geometry,  # use the geometry variable
...
#Join CBD zones with Greater Perth map data
Greater_Perth_JTW_by_DZ_and_LGA_2016 <- left_join(Greater_Perth_JTW_by_DZ_and_LGA_2021, CBD_dz_codes, by = "dz_code_2021")
