...
#JUST NEED TO REDO for 20216 data, then import the whole lot into R





Greater_Perth_JTW_by_DZ_and_LGA_2016 <- read_csv("01 data/Greater_Perth_JTW_by_DZ_and_LGA_2016_test.csv")
Greater_Perth_JTW_by_DZ_and_LGA_2021 <- read_csv("01 data/Greater_Perth_JTW_by_DZ_and_LGA_2016_test.csv")
...
#Convert DZN column to character
Greater_Perth_JTW_by_DZ_and_LGA_2016$`DZN (POW)` <- as.character( Greater_Perth_JTW_by_DZ_and_LGA_2016$`DZN (POW)`)
Greater_Perth_JTW_by_DZ_and_LGA_2021$`DZN (POW)` <- as.character( Greater_Perth_JTW_by_DZ_and_LGA_2021$`DZN (POW)`)
...
#do same updates on Mode and DZ and LGA files
names(Greater_Perth_JTW_by_DZ_and_LGA_2016) <- c("lga_name_2021", "dz_code_2016", names(Greater_Perth_JTW_by_DZ_and_LGA_2016[,3:ncol(Greater_Perth_JTW_by_DZ_and_LGA_2016)]))
names(Greater_Perth_JTW_by_DZ_and_LGA_2021) <- c("lga_name_2021","dz_code_2021", names(Greater_Perth_JTW_by_DZ_and_LGA_2021[,3:ncol(Greater_Perth_JTW_by_DZ_and_LGA_2021)]))
...
Greater_Perth_JTW_by_DZ_and_LGA_2016 <- tibble(Greater_Perth_JTW_by_DZ_and_LGA_2016[,1:18])
Greater_Perth_JTW_by_DZ_and_LGA_2021 <- tibble(Greater_Perth_JTW_by_DZ_and_LGA_2021[,1:18])
...
Greater_Perth_JTW_by_DZ_and_LGA_2016 <- tibble(dz_code_2021 = Greater_Perth_JTW_by_DZ_and_LGA_2016$DZN_CODE_2021, Greater_Perth_JTW_by_DZ_and_LGA_2016[,27:39])
