...
#Load 2021 JTW by destination zone and LGA into list
Greater_Perth_JTW_by_DZ_and_LGA_2016 <-
  list.files(path = ".", pattern = "*.csv") %>% 
  map_dfr(~read_csv(.))
Greater_Perth_JTW_by_DZ_and_LGA_2016

#Load 2021 JTW by destination zone and LGA into list
Greater_Perth_JTW_by_DZ_and_LGA_2021 <-
  list.files(path = ".", pattern = "*.csv") %>% map(~read_csv("."))
Greater_Perth_JTW_by_DZ_and_LGA_2021
